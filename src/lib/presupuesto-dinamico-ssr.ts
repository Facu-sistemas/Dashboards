...
/** Mirrors the other tabs' SSR pattern (see pareto-clients-ssr.ts): prefetch server-side under the same query keys the client island uses, so the first paint has real numbers instead of skeletons. */
